...
class ShowProduct extends React.Component {
    ...
    render() { 
        return ( 
            <div>
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">+9
                ...
                <div className="collapse navbar-collapse" id="main_navigation">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="/AddProduct">Add Room</a>
                    </li>
                    <li className="nav-item">
      ...
      <div class="col-md-7 px-3">
        ...
        <p class="card-text">Addresss: {this.state.product.address}</p>
          ...
          <div className="panel-body">
                           <dl>
                                <dt>Rent : {this.state.product.price + " ₹/month"} </dt>
                            ...
                            <div className="row">
                                <div className="col">
                                    <Link to={`/edit/${this.state.key}`} className="btn btn-secondary">Edit</Link>
                                </div>
                                <div className="col">
                                    <button onClick={this.delete.bind(this,this.state.key)} className="btn btn-secondary">Delete</button>
                                </div>
                            </div>
