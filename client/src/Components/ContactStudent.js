...
class ContactStudent extends React.Component {
  logout(){
  ...
  render() {
    return (
      ...
      <div className="contact-infomation">
		...
		<iframe  src="assets/images/map.png" width='100%' height="550" frameborder="0" allowFullScreen='' style={{border:"0"}} title="iframe"></iframe>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-12 col-md-6">
                <div className="layout-2col-ti_right">
                  <div className="contact-content_right"><img className="img-fluid" src="assets/images/hostelrent.svg" alt="contact"/></div>
                </div>
              </div>
            </div>
          </div>
